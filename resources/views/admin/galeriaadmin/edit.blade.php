...
@section('admin')
    <form action="{{ route('galeria.update', $galeria[0]->id) }}" method="POST" class="form-admin" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <h1>
            EDITAR
        ...
        @endif
        <div class="file">
            <h3 id="nombre_archivo"><img src="{{ asset('storage' . '/' . $galeria[0]->image) }}" width="250" alt="">
            </h3>
