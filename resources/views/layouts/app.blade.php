                            ...
                            <nav class="navigation navbar navbar-expand-md navbar-dark ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarsExample04">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        @else
                                            <script>
                                                document.getElementById("swal_Alert").addEventListener("click", () => alert(
                                                    "Inicia sesion para reservar por favor."));
                                            </script>
                                        @endif
                                        @guest
                                            @if (Route::has('login'))
                                                ...
                                                @else
                                                    <li>
                                                        <a href="{{ route('login') }}"
                                                            class="btn btn-outline-danger">ENTRAR</a>
                                                    </li>
                                                    @if (Route::has('register'))
                                                        <li>
                                                            <a href="{{ route('register') }}"
                                                                class="btn btn-outline-danger ml-2 ">REGISTRATE</a>
                                                        </li>
                                                    @endif
                                                @endauth
                                            @endif
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="link_menu">
                                <li class="{{ request()->is('/') ? 'active' : '' }}"><a
                                        href="{{ route('index') }}">Hogar</a></li>
                                <li class="{{ request()->is('habitaciones') ? 'active' : '' }}"><a
                                        href="{{ route('habitaciones') }}">Habitaciones</a></li>
                                <li class="{{ request()->is('acerca-de') ? 'active' : '' }}"><a
                                ...
                                <li class="{{ request()->is('contactanos') ? 'active' : '' }}"><a
                                        class="{{ request()->is('contactanos') ? 'active' : '' }}"
                                        href="{{ route('contactanos') }}">Contactanos</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <h3>Boletin informativo</h3>
                            <form class="bottom_form">
                                <input class="enter" placeholder="Ingresa tu email" type="text"
                                    name="Enter your email">
                                <button class="sub_btn">suscribete</button>
                            </form>
                            <ul class="social_icon">
                                <li><a href="https://www.instagram.com/rancho_alto_/" target="_blank"><i
